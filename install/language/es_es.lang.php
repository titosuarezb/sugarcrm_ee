...
$mod_strings = array(
  ...
  'LBL_SYSOPTS_2' => '¿Qué tipo de base de datos será utilizada para la instancia de SugarCRM que está a punto de instalar?',
  ...
  'ERR_ADMIN_USER_NAME_BLANK' => 'Provea el nombre de usuario para el usuario administrador de SugarCRM. ',
  'ERR_ADMIN_PASS_BLANK' => 'Provea una contraseña para el usuario administrador de SugarCRM. ',
  //'ERR_CHECKSYS_CALL_TIME'			=> 'Allow Call Time Pass Reference is Off (please enable in php.ini)',
  'ERR_CHECKSYS' => 'Se detectaron errores durante la verificación de compatibilidad.  Para que su instalación de SugarCRM funcione correctamente, por favor realice los pasos necesarios para corregir los inconvenientes listados más abajo, y vuelva a presionar el botón volver a verificar, o vuelva a intentar realizar la instalación nuevamente.',
  'ERR_CHECKSYS_CALL_TIME' => 'Allow Call Time Pass Reference está Activado (debería estar en Off en el archivo php.ini)',
  'ERR_CHECKSYS_CURL' => 'No encontrado: el planificador de tareas de SugarCRM se ejecutará con funcionalidad limitada.',
  ...
  'ERR_CHECKSYS_PHP_INVALID_VER' => 'Su versión de PHP no es soportada por SugarCRM. Deberá instalar una versión que sea compatible con la aplicación SugarCRM. Por favor consulte la Matriz de Compatibilidad en las Notas de la Versión para conocer las versiones de PHP soportadas. Su versión es ',
  'ERR_CHECKSYS_IIS_INVALID_VER' => 'Su versión de IIS no es soportada por SugarCRM. Deberá instalar una versión que sea compatible con la aplicación SugarCRM. Por favor consulte la Matriz de Compatibilidad en las Notas de la Versión para conocer las versiones de IIS soportadas. Su versión es ',
  'ERR_CHECKSYS_FASTCGI' => 'Detectamos que no está utilizando un FastCGI handler mapping para PHP. Deberá instalar/configurar una versión que sea compatible con SugarCRM. Por favor consulte la Matriz de Compatibilidad en las Notas de la Versión para conocer las versiones soportadas. Vea <a href="http://www.iis.net/php/" target="_blank">http://www.iis.net/php/</a> para más detalles ',
  ...
  'ERR_CHECKSYS_ZLIB' => 'ZLib no se encontró: SugarCRM alcanza grandes beneficios de performance con la compresión zlib.',
  'ERR_CHECKSYS_ZIP' => 'ZIP no se encontró: SugarCRM necesita soporte ZIP para procesar archivos comprimidos.',
  'ERR_CHECKSYS_PCRE' => 'PCRE no se encontró: SugarCRM necesita la librería PCRE para procesar expresiones regulares en el estilo Perl.',
  'ERR_CHECKSYS_PCRE_VER' => 'PCRE versión de librería: SugarCRM necesita la versión 7.0 o superior de la librería PCRE para procesar expresiones regulares en el estilo Perl.',
  ...
  'ERR_DB_MYSQL_VERSION' => 'Su versión de MySQL (%s) no es soportada por SugarCRM.  Deberá instalar una versión que sea compatible con SugarCRM. Por favor consulte la Matriz de Compatibilidad en las Notas de Versión para conocer las versiones soportadas.',
  ...
  'ERR_PASSWORD_MISMATCH' => 'Las contraseñas provistas para el usuario admin de SugarCRM no coinciden.  Por favor vuelva a ingresar las mismas contraseñas en los campos.',
  ...
  'ERR_PERFORM_NO_TCPIP' => '<b>No hemos podido detectar una conexión a Internet.</b> Cuando tenga una conexión, por favor visite <a href="http://www.suitecrm.com/">http://www.suitecrm.com/</a> para registrarse con SugarCRM. Si nos cuenta un poco cómo su compañía planea utilizar SugarCRM podremos asegurarnos de entregarle la aplicación correcta para las necesidades de su negocio.',
  ...
  'ERR_URL_BLANK' => 'Provea la URL base para su instancia de SugarCRM.',
  'ERR_UW_NO_UPDATE_RECORD' => 'No se pudo encontrar el registro de instalación de ',
  'ERROR_FLAVOR_INCOMPATIBLE' => 'El archivo subido no es compatible con esta edición (Community Edition, Professional, o Enterprise) de SugarCRM: ',
  ...
  'ERROR_VERSION_INCOMPATIBLE' => 'El archivo subido no es compatible con esta versión de SugarCRM: ',
  'LBL_BACK' => 'Atrás',
  'LBL_CANCEL' => 'Cancelar',
  'LBL_ACCEPT' => 'Acepto',
  'LBL_CHECKSYS_1' => 'Para que su instalación de SugarCRM funcione correctamente, por favor asegúrese de que todos los items por verificar listados más abajo estén en verde. Si encuentra alguno en rojo, por favor realice los pasos necesarios para solucionarlos.<BR><BR> Para obtener ayuda por estos items, visite <a href="http://www.suitecrm.com" target="_blank">SugarCRM</a>.',
  ...
  'LBL_DBCONF_DB_DROP_CREATE_WARN' => 'Atención: Toda la información de SugarCRM será eliminada<br>si se marca esta casilla.',
  ...
  'LBL_DBCONFIG_MSG3' => 'Nombre de la base de datos que contendrá la información de la instancia de SugarCRM que está a punto de instalar:',
  'LBL_DBCONFIG_B_MSG1' => 'The username and password of a database administrator who can create database tables and users and who can write to the database is necessary in order to set up the SugarCRM database.',
  'LBL_DBCONFIG_B_MSG1' => 'Para configurar la base de datos de SugarCRM es necesario el nombre de usuario y contraseña de un administrador de base de datos que pueda crear las tablas, usuarios y escribir en ella.',
  'LBL_DBCONFIG_SECURITY' => 'Por razones de seguridad, se puede especificar un usuario exclusivo para conectar a la base de datos de SugarCRM. Este usuario debe ener permisos para escribir, modificar y recuperar información de la base de datos de SugarCRM que será creada para esta instancia. Este usuario puede ser el administrador de base de datos que se especificó más arriba, usted puede proveer uno nuevo o uno existente.',
  ...
  'LBL_DISABLED_HELP_2' => 'foro de soporte de SugarCRM',
  ...
  'LBL_LAUNCHING_SILENT_INSTALL' => 'Instalando SugarCRM.  Este proceso puede tomar unos minutos.',
  ...
  'LBL_LOCALE_DESC' => 'La configuración regional se verá reflejada globalmente en la instancia de SugarCRM.',
  ...
  'LBL_PERFORM_CREATE_DEFAULT' => 'Creando información por defecto de SugarCRM',
  ...
  'LBL_PERFORM_OUTRO_1' => 'La configuración de SugarCRM ',
  ...
  'LBL_PRINT' => 'Imprimir',
  'LBL_REG_CONF_1' => 'Por favor complete el breve formulario a continuación para recibir anuncios de productos, novedades de capacitaciones, ofertas especiales e invitaciones epeciales a eventos de SugarCRM. No vendemos, alquilamos, compartimos ni distribuimos de ninguna forma la información recolectada aquí.',
  ...
  'LBL_REG_CONF_3' => 'Gracias por registrarse. Haga click en el botón Finalizar para ingresar a SugarCRM. Necesitará ingresar por primera vez utilizando el nombre de usuario "admin" y la contraseña que ingresó en el paso 2.',
  ...
  'LBL_SITECFG_ADMIN_Name' => 'Nombre del Administrador de SugarCRM',
  ...
  'LBL_SITECFG_CUSTOM_ID_DIRECTIONS' => 'Si se selecciona, deberá proveer un ID de Aplicación para sobreescribir el ID autogenerado. El ID asegura que las sesiones de una instancia de SugarCRM no sean usadas por otras instancia. Si tiene un cluster de instalaciones de SugarCRM, todas deberían compartir el mismo ID de aplicación.',
  'LBL_SITECFG_CUSTOM_ID' => 'Provea su propio ID de Aplicación',
  'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS' => 'Si se selecciona, deberá especificar un directorio de logs para sobreescribir el directorio por defecto del log de SugarCRM. Sin importar dónde esté ubicado el archivo de log, el acceso a través de navegador se deberá restringir utilizando una redirección .htacces.',
  'LBL_SITECFG_CUSTOM_LOG' => 'Utilizar un Directorio Personalizado para Logs',
  'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS' => 'Si se selecciona, deberá proveer un directorio seguro para almacenar la información de sesiones de SugarCRM. Esto se puede hacer para evitar que la información de la sesión sea vulnerada en servidores compartidos.',
  'LBL_SITECFG_CUSTOM_SESSION' => 'Utilizar un Directorio Personalizado para las Sesiones de SugarCRM',
  ...
  'LBL_SITECFG_URL' => 'URL de la Instancia de SugarCRM',
  'LBL_SITECFG_USE_DEFAULTS' => '¿Utilizar valores por defecto?',
  'LBL_SITECFG_ANONSTATS' => '¿Enviar estadísticas anónimas de uso?',
  'LBL_SITECFG_ANONSTATS_DIRECTIONS' => 'Si se selecciona, SugarCRM enviará estadísticas <b>anónimas</b> acerca de su instalación a SugarCRM Inc. cada vez que su sistema verifique nuevas versiones. Esta información nos ayudará a mejorar nuestra comprensión de cómo la aplicación es utilizada, y guiará las mejoras del producto.',
  'LBL_SITECFG_URL_MSG' => 'Ingrese la URL que será utilizada para acceder a la instancia de SugarCRM después de la instalación. La URL también va a ser utilizada como base para para las URL en las páginas de la aplicación. La URL puede incluir el nombre del servidor web, nombre del equipo o dirección IP.',
  'LBL_SITECFG_SYS_NAME_MSG' => 'Ingrese un nombre para su sistema. El nombre se mostrará en la barra de título del navegador cuando los usuarios visiten la aplicación SugarCRM.',
  'LBL_SITECFG_PASSWORD_MSG' => 'Después de la instalación, necesitará utilizar el usuario administrador de SugarCRM (nombre por defecto = admin) para ingresar a la instancia de SugarCRM. Ingrese  una contraseña para este usuario administrador. Esta contraseña puede ser cambiada después de ingresar por primera vez. También puede ingresar otro nombre de usuario diferente al valor por defecto provisto.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
  ...
  'LBL_WELCOME_1' => 'Este instalador crea las tablas de la base de datos de SugarCRM y establece los valores de configuración que ustede necesita para comenzar. El proceso completo debería tomar aproximadamente diez minutos.',
  'LBL_WELCOME_2' => 'Para obtener documentación de la instalación, por favor visite <a href="http://www.SugarCRM.com/" target="_blank">SugarCRM</a>.  <BR><BR> También podrá encontrar ayuda de la Comunidad de SugarCRM en los <a href="http://www.SugarCRM.com/" target="_blank">Foros de SugarCRM</a>.',
  ...
  'Al comenzar el proceso de instalacion, se realizará un chequeo de sistema en el servidor web en el cual están ubicados los archivos de SugarCRM con el objetivo de asegurar que el sistema está correctamente configurado y que tiene todos los componentes necesarios para completar la instalación exitosamente. <br><br>
					  ...
					  <li>Los siguientes archivos de SugarCRM deben ser editables:<ul><li><b>/custom</li>
<li>/cache</li>
<li>/modules</li>
<li>/upload</b></li></ul></li></ul>
  ...
  'Después de realizado el chequeo del sistema, puede seleccionar entre instalación Típica o Personalizada..<br><br>
                      ...
                      <ul>
                      <li> <b>Tipo de Base de Datos</b> que albergará la información de SugarCRM <ul><li>Tipos de Base de Datos Compatibles: MariaDB, MySQL o SQL Server.<br><br></li></ul></li>
                      <li> <b>Nombre del servidor web</b> o equipo (host) en el cual se encuentra la base de datos
                      <ul><li>Puede ser <i>localhost</i> si la base de datos se encuentra en su equipo local, o en el mismo servidor web o equipo que los archivos de SugarCRM.<br><br></li></ul></li>
                      <li><b>Nombre de la base de datos</b> que desea utilizar para albergar la información de SugarCRM</li>
                        <ul>
                          <li> Quizás usted ya tenga una base de datos existente que desearía utilizar. Si usted provee el nombre de una base de datos existente, se eliminarán las tablas existentes de la base de datos durante la instalación cuando se defina el nuevo esquema para la base de datos de SugarCRM.</li>
                      ...
                      Esta URL puede incluir el nombre o dirección IP del servidor o equipo.<br><br></li>
                                  <li> [Opcional] <b>Ruta del directorio de sesión</b> si desea utilizar un directorio personalizado para la información de SugarCRM con el objetivo de evitar vulnerabilidad en servidores compartidos.<br><br></li>
                                  <li> [Opcional] <b>Ruta personalizada del directorio de log</b> si desea sobreescribir el directorio por defecto utilizado para los archivos de log de SugarCRM.<br><br></li>
                                  <li> [Opcional] <b>ID de Aplicación</b> si desea sobreescribir el ID autogenerado para garantizar que las sesiones de una instancia de SugarCRM no son utilizadas por otras instancias.<br><br></li>
  ...
  'LBL_WELCOME_TITLE' => 'Asistente de Configuración de SugarCRM',
  'LBL_WIZARD_TITLE' => 'Asistente de Configuración de SugarCRM: ',
  'LBL_YES' => 'Sí',
  ...
  'LBL_SESSION_ERR_DESCRIPTION' => "SugarCRM depende de las Sesiones de PHP para almacenar información importante mientras se conecta al servidor web. Su instalación de PHP no tiene la información de Sesiones correctamente configurada. 
  ...
  'LBL_REQUIRED_SYSTEM_NAME' => 'Provea un Nombre de Sistema para su instancia SugarCRM.',
